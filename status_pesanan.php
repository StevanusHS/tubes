  ...
  <body>
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          ...
          <hr>
          <p class="lead font-weight-bold">Food & Beverage</p>
        </div>
      </div>
      ...
      <nav class="navbar navbar-expand-lg  bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link mr-4" href="menu_pembeli.php">MENU</a>
            </li>
            <li class="nav-item">
  ...
  <!-- Menu -->
    <div class="container">
      <div class="judul-pesanan mt-5">
        ...
        <h3 class="text-center font-weight-bold">STATUS PESANAN ANDA</h3>
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="hapus_pesanan.php?id_menu=<?php echo $id_menu ?>" class="badge badge-danger">Lihat detail</a>
            </td>
          </tr>
            <?php $nomor++; ?>
